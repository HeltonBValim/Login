...
<html lang="pt-br">
    <head>
        ...
        <title>Testes com BDs - Página Inicial</title>
    </head>
    <body>
        <!--
            @Autor : HeltonBValim
            Arquivo index.html para aquisição de dados via formulário
        -->
        <div>
            <p>
            Para Consultar tudo ou Deletar tudo, deixe os campos em branco<br/>
            Para Inserir ou Alterar, ambos os campos devem sem preenchidos.<br>
            </p>
            <form method="post" action="gravar.php">
                <label for="iuser">Usuário: </label>
                <input type="text" name="nome" id="iuser"/></br>
                <label for="ipass">Senha: </label>
                <input type="password" name="psw" id="ipass"/></br>
